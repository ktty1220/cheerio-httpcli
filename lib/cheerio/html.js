...
module.exports = function (encoding, client, cheerio) {
   ...
   * [DEPRICATED] 将来削除予定
   */
  var depricatedMessage = '%s() will be removed in the future)';
  cheerio.prototype._text = function (str) {
    cutil.depricated(util.format(depricatedMessage, '_text'));
    return this.text(str);
  };

  cheerio.prototype._html = function (str) {
    cutil.depricated(util.format(depricatedMessage, '_html'));
